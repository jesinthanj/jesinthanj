...
**Software Engineer · Data Science & Analytics · QA Automation · Full Stack & WebApps**
...
[![Email](https://img.shields.io/badge/Email-jesinthan.ie%40gmail.com-informational?logo=gmail)](mailto:jesinthan.ie@gmail.com)
[![Résumé](https://img.shields.io/badge/Resume-Download-22c55e?logo=adobeacrobatreader)](#)
...
**Databases**  
PostgreSQL · MySQL · MongoDB · Redis · (Snowflake familiarity)
...
- **Reproducible by default**: Makefiles/Taskfiles, `requirements.txt`/`pyproject.toml`, lockfiles.  
- **Observability**: structured logs, metrics, health endpoints.  
- **Automation**: CI checks (lint, type‑check, tests), Dockerized dev envs.  
- **Docs**: READMEs with quick starts, architecture diagrams, API examples.  
- **Stakeholder‑first**: crisp releases, changelogs, and feedback loops.

---

## 🏆 Highlights & leadership
- **FABLAB Invention Award** for leadership and team spirit.  
- Founded **Pattarai** (student tech association) to bridge academics ↔ industry.  
- **Tekion (QA/SDET → Full‑stack)**: shipped major releases smoothly; promoted for reliability.  
- Rotaract leadership; frequent presenter and workshop host.
...
<sub>Last updated: November 2025 · Built with ❤️ for clarity, reliability, and shipped software.</sub>
